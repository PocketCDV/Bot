notifications = 🔔 <b>Notifications</b>
    ...
    There are two types of notifications - upcoming and daily.
    Notifications about upcoming classes are just reminders for each class, which arrives one hour before the class starts.
